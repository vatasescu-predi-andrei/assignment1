...
public abstract class ClosedShape {
	...
	protected Color colourTwo;
	/**
	 * The line colour of the shape, or the filled in
	 * colour if the Shape has fill used as an auxiliary variable.
	 * when switching between two colours
	 */

	protected Color colourThree;
	 ...
	 * @param insertionTime insertion time
	 * @param x The x position.
	 * @param y the y position.
	 * @param colour The line or fill colour.
	 * @param isFilled True if the shape is filled, false if not.
	 * @param isFlashing True if the shape is changing colour while moving, false otherwise
	 * @param colourTwo Second changing colour
	 */
	protected ClosedShape (String type,int insertionTime, int x, int y, int vx, int vy, Color colour, boolean isFilled
	, boolean isFlashing, Color colourTwo) {
		this.type=type;
		this.x = x;
		this.y = y;
		this.xVec = vx;
	...
	/**
	 * @return True if the shape is changing colour when moving, false otherwise
	 */
