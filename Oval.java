...
public class Oval extends ClosedShape {
	 ...
	 * @param isFlashing True if the oval is changing colour while moving, false otherwise.
	 * @param colourTwo Second changing colour.
	 */
	public Oval (String type, int insertionTime, int x, int y, int vx, int vy, int width, int height, Color colour,
